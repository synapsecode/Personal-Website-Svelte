...
const myAge = Math.floor((new Date() - new Date(2003, 10, 18))/1000/60/60/24/365)

let aboutme = ` Hey! I'm Manas Hejmadi, a ${myAge} year old Student, Developer and Startup
...
let other_works_desc = {
	MLBlog: "This is a Blog Post series about Basic Machine Learning!"
}
...
let testimonial_data = [
	{
		...
		He is so kind and truly awesome at what he does. He delivered a product that I\
		 was pleased with. He made sure to communicate his progress and kept me informed throughout\
		  this process. He was so helpful in making any changes that I asked. He was also very\
		   helpful in explaining things that I had questions about, He is very timely and always\
